...
local aa = {
    ...
    [16] = function()
        ...
        return function(n)
            ...
            o.CloseButton = q(i.Close, UDim2.new(1, -4, 0, 4), o.Frame, function()
                p.Window:Dialog{
                    Title = 'Close',
                    Content = 'Are You Sure You Want To Close DaxonHub ?',
                    Buttons = {{
                        Title = 'Yes',
                        Callback = function()
                            p:Destroy()
    ...
    [47] = function()
        ...
        local af = {
            Names = {'Dark', 'Darker', 'Light', 'Aqua', 'Amethyst', 'Rose', 'DaxonHub'}
        }
    ...
    [54] = function()
        ...
        return {
            ...
            InElementBorder = Color3.fromRGB(100, 100, 100), -- เทาเข้ม
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(255, 230, 100), -- เหลือง
            ToggleToggled = Color3.fromRGB(0, 0, 0), -- ดำ
            SliderRail = Color3.fromRGB(255, 215, 0),
            DropdownFrame = Color3.fromRGB(60, 60, 60), -- เทาเข้ม
            DropdownHolder = Color3.fromRGB(30, 30, 30), -- ดำ
            DropdownBorder = Color3.fromRGB(90, 90, 90), -- เทากลาง
            DropdownOption = Color3.fromRGB(255, 230, 100),
            Keybind = Color3.fromRGB(255, 230, 100),
            Input = Color3.fromRGB(255, 230, 100),
            InputFocused = Color3.fromRGB(50, 50, 50), -- เทาเข้ม
            InputIndicator = Color3.fromRGB(255, 200, 0),
            Dialog = Color3.fromRGB(40, 40, 40),
            DialogHolder = Color3.fromRGB(30, 30, 30),
            DialogHolderLine = Color3.fromRGB(60, 60, 60),
            DialogButton = Color3.fromRGB(255, 230, 100),
